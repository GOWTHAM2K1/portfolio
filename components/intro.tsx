...
import screenshot from "@/public/Screenshot_1.png"
...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Gowtham.</span> I'm a{" "}
        <span className="font-bold">I am fresher in development</span> with{" "}
        <span className="font-bold">experience</span> in various frameworks. I enjoy
        building <span className="italic">sites & solving problems</span>. My focus is{" "}
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/gowtham-k-a4ba57213/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/GOWTHAM2K1"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
